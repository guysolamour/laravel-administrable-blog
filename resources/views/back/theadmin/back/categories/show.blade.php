...
<div class="main-content">
    ...
    <div class="fab fab-fixed">
        ...
        <ul class="fab-buttons">
            ...
            <li><a class="btn btn-float btn-sm btn-danger" href="{{ back_route('extensions.blog.category.destroy',$category) }}" data-method="delete" data-confirm="{{ Lang::get('administrable-blog::translations.view.category.destroy') }}"   data-provide="tooltip"
