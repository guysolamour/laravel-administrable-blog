...
class Post extends BaseModel implements HasMedia
{
    ...
    {
        return $this->belongsToMany(config('administrable-blog.models.category'), 'extensions_blog_post_category');
    }


    public function tags()
    {
        return $this->belongsToMany(config('administrable-blog.models.tag'), 'extensions_blog_post_tag');
    }
