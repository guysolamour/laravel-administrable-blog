...
namespace Guysolamour\Administrable\Extensions\Blog\Console\Commands;

use Illuminate\Support\Str;
use Guysolamour\Administrable\Console\Extension\BaseExtension;
use Guysolamour\Administrable\Extensions\Blog\ServiceProvider;
...
class InstallExtensionCommand extends BaseExtension
{
    ...
    protected function addPostRelationInDefaultGuardModel(): void
    {
        ...
        $search
            ...
            {
                return \$this->hasMany(config('administrable-blog.models.post'), 'author_id');
            }
        TEXT;
